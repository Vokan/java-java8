...
public class Stream_03_Test {
    ...
    public void test_joining() throws Exception {
        ...
        String result = customers.stream().sorted(Comparator.comparing(Customer::getFirstname))
    ...
    public void test_grouping() throws Exception {
        ...
        Map<Customer, List<Order>> result = orders.stream().collect(Collectors.groupingBy(Costumer::));
