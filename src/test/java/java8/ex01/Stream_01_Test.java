...
public class Stream_01_Test {
    ...
    public void test_stream_filter() throws Exception {
        ...
        List<Pizza> result = pizzas.stream().filter(unePizza->unePizza.getPrice()>=1300).collect(Collectors.toList());
    ...
    public void test_stream_anyMatch() throws Exception {
        ...
        Boolean result1 = pizzas.stream().anyMatch(unePizza->unePizza.getPrice()>=1300);
        // TODO valider si au moins une pizza à un prix >= 2000
        Boolean result2 = pizzas.stream().anyMatch(unePizza->unePizza.getPrice()>=2000);
    ...
    public void test_stream_allMatch() throws Exception {
        ...
        Boolean result1 = pizzas.stream().allMatch(unePizza->unePizza.getPrice()>=1300);

        // TODO valider que toutes les pizzas ont un prix >= 900
        Boolean result2 = pizzas.stream().allMatch(unePizza->unePizza.getPrice()>=900);
    ...
    public void test_stream_noneMatch() throws Exception {
        ...
        Boolean result1 = pizzas.stream().noneMatch(unePizza->unePizza.getPrice()>=2000);
    ...
    public void test_stream_findFirst() throws Exception {
        ...
        Optional<Order> result =orders.stream().filter(oneOrder->oneOrder.getCustomer().getFirstname().equals("sophie")).findFirst();
